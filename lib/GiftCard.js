  ...
  if ((code === "") || (code.length !== 16)) {
    ...
    alert("Please enter a 4-digit pin number");
      ...
      if (codes[code]["pin"] !== pin){
        ...
        myStorage.setItem("oldBalance", myStorage.getItem("credit"));
        myStorage.setItem("credit", newBalance);
...
$("#current-balance").text("Previous Balance: " + myStorage.getItem("oldBalance"));
$("#added-value").text("Gift Card Value: " + myStorage.getItem("codeAmount"));
$("#new-balance").text("New Balance: " + myStorage.getItem("credit"));
